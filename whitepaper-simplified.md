...
12月 | 在Ethereum上构建Quantstamp验证/付款智能合同 <br/>完成第4次半自动审核
**2018** | &nbsp;
...
Quantstamp网络为SAT领域提供了一个迷人而令人兴奋的机会。 Quantstamp正在建立一种新的分布式SAT解决方案，其中内置了共识和冗余，并激励参与者解决所有SAT问题的各种问题，以求索赔和认证合同。 将这项技术应用于智能合同尤其令人兴奋，因为有这么多的关键。
